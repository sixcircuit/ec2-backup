...
{
    $snapRequest = new Amazon_EC2_Model_CreateSnapshotRequest();
    $snapRequest->setVolumeId($volume);
    $snapRequest->setDescription($volume . " Backup: " . date(DATE_ATOM));
    invokeCreateSnapshot($service, $snapRequest);
}
